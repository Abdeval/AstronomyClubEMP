      ...
      <div className="container relative mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between mb-8">
          <motion.div
            ...
            className="md:order-2 mb-16 md:mb-0 pl-4"
          >
            ...
            >
              <motion.div className="flex">
                {planets.map((planet) => (
                  ...
                  >
                    <Card 
                      className="w-64 rounded-[16px] border border-muted/30 overflow-hidden transition-all 
                      duration-300 ease-in-out hover:opacity-80 bg-secondary/30"
                    >
                      <CardHeader className="p-0">
                        <img src={planet.image || "/placeholder.svg"} alt={planet.name} 
