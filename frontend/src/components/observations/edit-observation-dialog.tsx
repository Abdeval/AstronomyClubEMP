...
export default function EditObservationDialog({
  ...
  const [existingImages, setExistingImages] = useState(observation.images || [])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      ...
      // For this example, we'll create object URLs for the new images
      const uploadedNewImages = newImages.map((file, index) => ({
        id: `temp-new-${index}`,
      ...
      <DialogContent className="sm:max-w-[600px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>Update your astronomical observation details and images.</DialogDescription>
          </DialogHeader>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {existingImages.map((image, index) => (
                        <div key={`existing-${index}`} className="relative w-20 h-20 rounded-md overflow-hidden group">
                          <img
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {newImageUrls.map((url, index) => (
                        <div key={`new-${index}`} className="relative w-20 h-20 rounded-md overflow-hidden group">
                          <img
